...
public class BookmarkAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BookmarkAdapter adapter_this;
    ...
    public static class BookmarkViewHolder extends RecyclerView.ViewHolder {
        ...
        public BookmarkViewHolder(View v) {
            super(v);
            titleTextView = v.findViewById(R.id.bookmark_card_text);
            imgView = v.findViewById(R.id.bookmark_card_img);
            cardView = v.findViewById(R.id.bookmark_card_view);
            bookmarkView = v.findViewById(R.id.bookmark_card_bookmark);
            subView = v.findViewById(R.id.bookmark_card_sub);
        }
    }

    @SuppressLint("CommitPrefEdits")
    public BookmarkAdapter(Context context, List<CardData> myDataset, LinearLayout pb_layout) {
        mDataset = myDataset;
        mContext = context;
        sharedPreferences = mContext.getSharedPreferences("bookmark", 0);
        editor = sharedPreferences.edit();
        adapter_this = this;
        text_layout = pb_layout;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        BookmarkAdapter.BookmarkViewHolder bookmarkViewHolder = new BookmarkAdapter.BookmarkViewHolder(v);
        bookmarkViewHolder.cardView.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                int position = bookmarkViewHolder.getAdapterPosition();
        ...
        bookmarkViewHolder.bookmarkView.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                int position = bookmarkViewHolder.getAdapterPosition();
...
//                        System.out.println("remove bookmark");
                ...
                if (mDataset.size()==0) text_layout.setVisibility(View.VISIBLE);

                adapter_this.notifyDataSetChanged();
            }
        });

        bookmarkViewHolder.cardView.setOnLongClickListener(new View.OnLongClickListener(){
            @Override
...
//                        System.out.println("remove bookmark");
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        try {
            vh.subView.setText(mDataset.get(position).getSubB());
