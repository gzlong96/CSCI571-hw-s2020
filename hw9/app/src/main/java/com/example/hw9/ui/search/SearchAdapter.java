...
import com.example.hw9.ui.section.SectionTabAdapter;
...
public class SearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private SearchAdapter adapter_this;
    ...
    public SearchAdapter(Context context, List<CardData> myDataset) {
        mDataset = myDataset;
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        SearchAdapter.SearchViewHolder searchViewHolder = new SearchAdapter.SearchViewHolder(v);
        ...
        searchViewHolder.cardView.setOnLongClickListener(new View.OnLongClickListener(){
            @Override
...
//                        System.out.println("add bookmark");
        ...
        searchViewHolder.bookmarkView.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                int position = searchViewHolder.getAdapterPosition();
//                    System.out.println(position);
